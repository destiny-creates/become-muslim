...
class Huffman {
    ...
    void encode(C5869f c5869f, C7203d c7203d) {
        long j = 0;
        int i = 0;
        for (int i2 = 0; i2 < c5869f.mo5110h(); i2++) {
            int a = c5869f.mo5097a(i2) & JfifUtil.MARKER_FIRST_BYTE;
            int i3 = CODES[a];
            ...
            while (i >= 8) {
                i -= 8;
                c7203d.mo6307i((int) (j >> i));
            }
        }
        if (i > 0) {
            c7203d.mo6307i((int) ((j << (8 - i)) | ((long) (255 >>> i))));
        }
    }

    int encodedLength(C5869f c5869f) {
        long j = 0;
        for (int i = 0; i < c5869f.mo5110h(); i++) {
            j += (long) CODE_LENGTHS[c5869f.mo5097a(i) & JfifUtil.MARKER_FIRST_BYTE];
        }
        return (int) ((j + 7) >> 3);
    }
    ...
    byte[] decode(byte[] bArr) {
        ...
        for (byte b : bArr) {
            ...
            i2 += 8;
            while (i2 >= 8) {
                node = node.children[(i >>> (i2 - 8)) & JfifUtil.MARKER_FIRST_BYTE];
        ...
        while (i2 > 0) {
            bArr = node.children[(i << (8 - i2)) & JfifUtil.MARKER_FIRST_BYTE];
