...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new C66131();
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = of("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", JfifUtil.MARKER_FIRST_BYTE);
    ...
    class C66131 implements Comparator<String> {
        C66131() {
        }
