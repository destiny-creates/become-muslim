...
class X509CRLEntryObject extends X509CRLEntry {
    /* renamed from: a */
    private CRLEntry f22842a;
    /* renamed from: b */
    private X500Name f22843b;
    /* renamed from: c */
    private int f22844c;
    /* renamed from: d */
    ...
    protected X509CRLEntryObject(CRLEntry cRLEntry, boolean z, X500Name x500Name) {
        this.f22842a = cRLEntry;
        this.f22843b = m28034a(z, x500Name);
    }
    ...
    /* renamed from: a */
    private org.spongycastle.asn1.x500.X500Name m28034a(boolean r4, org.spongycastle.asn1.x500.X500Name r5) {
...
*/
    ...
    L_0x0035:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.jcajce.provider.asymmetric.x509.X509CRLEntryObject.a(boolean, org.spongycastle.asn1.x500.X500Name):org.spongycastle.asn1.x500.X500Name");
    }
...
*/
    ...
    L_0x0006:
        ...
        r2 = r3.f22843b;	 Catch:{ IOException -> 0x0012 }
    ...
    L_0x0012:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.jcajce.provider.asymmetric.x509.X509CRLEntryObject.getCertificateIssuer():javax.security.auth.x500.X500Principal");
    }

    /* renamed from: a */
    private Set m28033a(boolean z) {
        Extensions c = this.f22842a.m40418c();
        if (c == null) {
            return false;
        }
    ...
    public Set getNonCriticalExtensionOIDs() {
        return m28033a(false);
    }

    /* renamed from: a */
    private Extension m28035a(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions c = this.f22842a.m40418c();
        return c != null ? c.m40332a(aSN1ObjectIdentifier) : null;
    }

    public byte[] getExtensionValue(String str) {
        str = m28035a(new ASN1ObjectIdentifier(str));
        if (str == null) {
            return null;
        }
        try {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f22842a.equals(((X509CRLEntryObject) obj).f22842a);
    }

    public byte[] getEncoded() {
        try {
            return this.f22842a.m34596a("DER");
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f22842a.m40416a().m42968b();
    }

    public Date getRevocationDate() {
        return this.f22842a.m40417b().m40459b();
    }

    public boolean hasExtensions() {
        return this.f22842a.m40418c() != null;
    }
...
*/
    ...
    L_0x0066:
        ...
        r5 = ") ";
        r0.append(r5);
        r5 = org.spongycastle.asn1.x509.Extension.f31285i;	 Catch:{ Exception -> 0x00d7 }
    ...
    L_0x009f:
        r5 = org.spongycastle.asn1.x509.Extension.f31290n;	 Catch:{ Exception -> 0x00d7 }
        r5 = r4.equals(r5);	 Catch:{ Exception -> 0x00d7 }
    ...
    L_0x00f2:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.jcajce.provider.asymmetric.x509.X509CRLEntryObject.toString():java.lang.String");
    }
}
