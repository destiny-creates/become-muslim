...
public class SignatureSpi extends java.security.SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    private DSA bG = new GOST3410Signer();
...
*/
    ...
    L_0x000d:
        ...
        goto L_0x0026;
    L_0x0012:
        r3 = r3.getEncoded();	 Catch:{ Exception -> 0x003a }
        r3 = org.spongycastle.asn1.x509.SubjectPublicKeyInfo.m40409a(r3);	 Catch:{ Exception -> 0x003a }
        r3 = org.spongycastle.jce.provider.BouncyCastleProvider.m36189a(r3);	 Catch:{ Exception -> 0x003a }
        r0 = r3 instanceof org.spongycastle.jce.interfaces.ECPublicKey;	 Catch:{ Exception -> 0x003a }
        if (r0 == 0) goto L_0x0032;	 Catch:{ Exception -> 0x003a }
    L_0x0022:
        r3 = org.spongycastle.jcajce.provider.asymmetric.util.ECUtil.m28010a(r3);	 Catch:{ Exception -> 0x003a }
    L_0x0026:
        r0 = r2.bF;
        r0.mo5733c();
        r0 = r2.bG;
        ...
        return;
    L_0x0032:
        r3 = new java.security.InvalidKeyException;	 Catch:{ Exception -> 0x003a }
        r0 = "can't recognise key type in DSA based signer";	 Catch:{ Exception -> 0x003a }
    ...
    L_0x003a:
        ...
        throw r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.jcajce.provider.asymmetric.gost.SignatureSpi.engineInitVerify(java.security.PublicKey):void");
    }
    ...
    protected void engineInitSign(PrivateKey privateKey) {
        ...
        this.bF.mo5733c();
        if (this.bH != null) {
            this.bG.mo5800a(true, new ParametersWithRandom(privateKey, this.bH));
        } else {
...
*/
    ...
    L_0x0037:
        ...
        throw r7;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.jcajce.provider.asymmetric.gost.SignatureSpi.engineVerify(byte[]):boolean");
    }
