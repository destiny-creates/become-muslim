...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: a */
    private static void m34884a(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    /* renamed from: b */
    private static void m34889b(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    /* renamed from: c */
    private static void m34892c(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    /* renamed from: d */
    private static void m34893d(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    /* renamed from: a */
    private int m34882a(byte[] bArr, int i) {
        int i2 = 0;
    ...
    /* renamed from: a */
    private void m34883a(int i, byte[] bArr, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            bArr[(3 - i3) + i2] = (byte) i;
            i >>>= 8;
        }
    ...
    /* renamed from: a */
    private void m34886a(int[] iArr, int[] iArr2, int i) {
        int i2 = iArr[0] ^ iArr2[i + 0];
        i2 = f26581h[(i2 >>> 24) & JfifUtil.MARKER_FIRST_BYTE] ^ ((f26582i[i2 & JfifUtil.MARKER_FIRST_BYTE] ^ f26584k[(i2 >>> 8) & JfifUtil.MARKER_FIRST_BYTE]) ^ f26583j[(i2 >>> 16) & JfifUtil.MARKER_FIRST_BYTE]);
        int i3 = iArr[1] ^ iArr2[i + 1];
        i3 = (f26583j[(i3 >>> 24) & JfifUtil.MARKER_FIRST_BYTE] ^ ((f26581h[i3 & JfifUtil.MARKER_FIRST_BYTE] ^ f26582i[(i3 >>> 8) & JfifUtil.MARKER_FIRST_BYTE]) ^ f26584k[(i3 >>> 16) & JfifUtil.MARKER_FIRST_BYTE])) ^ i2;
        iArr[2] = iArr[2] ^ i3;
        iArr[3] = (m34881a(i2, 8) ^ i3) ^ iArr[3];
        i2 = iArr[2] ^ iArr2[i + 2];
        i2 = f26581h[(i2 >>> 24) & JfifUtil.MARKER_FIRST_BYTE] ^ ((f26582i[i2 & JfifUtil.MARKER_FIRST_BYTE] ^ f26584k[(i2 >>> 8) & JfifUtil.MARKER_FIRST_BYTE]) ^ f26583j[(i2 >>> 16) & JfifUtil.MARKER_FIRST_BYTE]);
        iArr2 = iArr2[i + 3] ^ iArr[3];
        iArr2 = (f26583j[(iArr2 >>> 24) & JfifUtil.MARKER_FIRST_BYTE] ^ ((f26581h[iArr2 & JfifUtil.MARKER_FIRST_BYTE] ^ f26582i[(iArr2 >>> 8) & JfifUtil.MARKER_FIRST_BYTE]) ^ f26584k[(iArr2 >>> 16) & JfifUtil.MARKER_FIRST_BYTE])) ^ i2;
        iArr[0] = iArr[0] ^ iArr2;
        iArr[1] = (iArr2 ^ m34881a(i2, 8)) ^ iArr[1];
    }

    /* renamed from: b */
    private void m34890b(int[] iArr, int[] iArr2, int i) {
        iArr[1] = iArr[1] ^ m34887b(iArr[0] & iArr2[i + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i + 3] | iArr[3]);
        iArr[3] = m34887b(iArr2[i + 2] & iArr[2], 1) ^ iArr[3];
    }

    /* renamed from: a */
    private void m34885a(boolean z, byte[] bArr) {
        int i;
        CamelliaEngine camelliaEngine = this;
        byte[] bArr2 = bArr;
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        ...
        if (length == 16) {
            camelliaEngine.f26586b = true;
            iArr[0] = m34882a(bArr2, 0);
            iArr[1] = m34882a(bArr2, 4);
            iArr[2] = m34882a(bArr2, 8);
            iArr[3] = m34882a(bArr2, 12);
            iArr[7] = 0;
            iArr[6] = 0;
            iArr[5] = 0;
            iArr[4] = 0;
            ...
            iArr[2] = m34882a(bArr2, 8);
            iArr[3] = m34882a(bArr2, 12);
            iArr[4] = m34882a(bArr2, 16);
            iArr[5] = m34882a(bArr2, 20);
            iArr[6] = ~iArr[4];
            iArr[7] = ~iArr[5];
            camelliaEngine.f26586b = false;
        } else if (length == 32) {
            iArr[0] = m34882a(bArr2, 0);
            iArr[1] = m34882a(bArr2, 4);
            iArr[2] = m34882a(bArr2, 8);
            ...
            iArr[4] = m34882a(bArr2, 16);
            iArr[5] = m34882a(bArr2, 20);
            iArr[6] = m34882a(bArr2, 24);
            iArr[7] = m34882a(bArr2, 28);
            camelliaEngine.f26586b = false;
        } else {
        ...
        m34886a(iArr2, f26580g, 0);
        for (i = 0; i < 4; i++) {
            iArr2[i] = iArr2[i] ^ iArr[i];
        }
        m34886a(iArr2, f26580g, 4);
        if (!camelliaEngine.f26586b) {
            for (i = 0; i < 4; i++) {
                iArr3[i] = iArr2[i] ^ iArr[i + 4];
            }
            m34886a(iArr3, f26580g, 8);
            if (z) {
                camelliaEngine.f26588d[0] = iArr[0];
                camelliaEngine.f26588d[1] = iArr[1];
                camelliaEngine.f26588d[2] = iArr[2];
                camelliaEngine.f26588d[3] = iArr[3];
                m34892c(45, iArr, 0, camelliaEngine.f26587c, 16);
                m34884a(15, iArr, 0, camelliaEngine.f26589e, 4);
                m34884a(17, iArr, 0, camelliaEngine.f26587c, 32);
                m34892c(34, iArr, 0, camelliaEngine.f26587c, 44);
                m34884a(15, iArr, 4, camelliaEngine.f26587c, 4);
                m34884a(15, iArr, 4, camelliaEngine.f26589e, 0);
                m34884a(30, iArr, 4, camelliaEngine.f26587c, 24);
                m34892c(34, iArr, 4, camelliaEngine.f26587c, 36);
                m34884a(15, iArr2, 0, camelliaEngine.f26587c, 8);
                m34884a(30, iArr2, 0, camelliaEngine.f26587c, 20);
                camelliaEngine.f26589e[8] = iArr2[1];
                camelliaEngine.f26589e[9] = iArr2[2];
                camelliaEngine.f26589e[10] = iArr2[3];
                camelliaEngine.f26589e[11] = iArr2[0];
                m34892c(49, iArr2, 0, camelliaEngine.f26587c, 40);
                camelliaEngine.f26587c[0] = iArr3[0];
                camelliaEngine.f26587c[1] = iArr3[1];
                camelliaEngine.f26587c[2] = iArr3[2];
                camelliaEngine.f26587c[3] = iArr3[3];
                m34884a(30, iArr3, 0, camelliaEngine.f26587c, 12);
                m34884a(30, iArr3, 0, camelliaEngine.f26587c, 28);
                m34892c(51, iArr3, 0, camelliaEngine.f26588d, 4);
                return;
            }
            camelliaEngine.f26588d[4] = iArr[0];
            camelliaEngine.f26588d[5] = iArr[1];
            camelliaEngine.f26588d[6] = iArr[2];
            camelliaEngine.f26588d[7] = iArr[3];
            m34893d(45, iArr, 0, camelliaEngine.f26587c, 28);
            m34889b(15, iArr, 0, camelliaEngine.f26589e, 4);
            m34889b(17, iArr, 0, camelliaEngine.f26587c, 12);
            m34893d(34, iArr, 0, camelliaEngine.f26587c, 0);
            m34889b(15, iArr, 4, camelliaEngine.f26587c, 40);
            m34889b(15, iArr, 4, camelliaEngine.f26589e, 8);
            m34889b(30, iArr, 4, camelliaEngine.f26587c, 20);
            m34893d(34, iArr, 4, camelliaEngine.f26587c, 8);
            m34889b(15, iArr2, 0, camelliaEngine.f26587c, 36);
            m34889b(30, iArr2, 0, camelliaEngine.f26587c, 24);
            camelliaEngine.f26589e[2] = iArr2[1];
            camelliaEngine.f26589e[3] = iArr2[2];
            camelliaEngine.f26589e[0] = iArr2[3];
            camelliaEngine.f26589e[1] = iArr2[0];
            m34893d(49, iArr2, 0, camelliaEngine.f26587c, 4);
            camelliaEngine.f26587c[46] = iArr3[0];
            camelliaEngine.f26587c[47] = iArr3[1];
            camelliaEngine.f26587c[44] = iArr3[2];
            camelliaEngine.f26587c[45] = iArr3[3];
            m34889b(30, iArr3, 0, camelliaEngine.f26587c, 32);
            m34889b(30, iArr3, 0, camelliaEngine.f26587c, 16);
            m34892c(51, iArr3, 0, camelliaEngine.f26588d, 0);
        } else if (z) {
            camelliaEngine.f26588d[0] = iArr[0];
            camelliaEngine.f26588d[1] = iArr[1];
            camelliaEngine.f26588d[2] = iArr[2];
            camelliaEngine.f26588d[3] = iArr[3];
            m34884a(15, iArr, 0, camelliaEngine.f26587c, 4);
            m34884a(30, iArr, 0, camelliaEngine.f26587c, 12);
            m34884a(15, iArr, 0, iArr4, 0);
            camelliaEngine.f26587c[18] = iArr4[2];
            camelliaEngine.f26587c[19] = iArr4[3];
            m34884a(17, iArr, 0, camelliaEngine.f26589e, 4);
            m34884a(17, iArr, 0, camelliaEngine.f26587c, 24);
            m34884a(17, iArr, 0, camelliaEngine.f26587c, 32);
            camelliaEngine.f26587c[0] = iArr2[0];
            camelliaEngine.f26587c[1] = iArr2[1];
            camelliaEngine.f26587c[2] = iArr2[2];
            camelliaEngine.f26587c[3] = iArr2[3];
            m34884a(15, iArr2, 0, camelliaEngine.f26587c, 8);
            m34884a(15, iArr2, 0, camelliaEngine.f26589e, 0);
            m34884a(15, iArr2, 0, iArr4, 0);
            camelliaEngine.f26587c[16] = iArr4[0];
            camelliaEngine.f26587c[17] = iArr4[1];
            m34884a(15, iArr2, 0, camelliaEngine.f26587c, 20);
            m34892c(34, iArr2, 0, camelliaEngine.f26587c, 28);
            m34884a(17, iArr2, 0, camelliaEngine.f26588d, 4);
        } else {
            camelliaEngine.f26588d[4] = iArr[0];
            camelliaEngine.f26588d[5] = iArr[1];
            camelliaEngine.f26588d[6] = iArr[2];
            camelliaEngine.f26588d[7] = iArr[3];
            m34889b(15, iArr, 0, camelliaEngine.f26587c, 28);
            m34889b(30, iArr, 0, camelliaEngine.f26587c, 20);
            m34889b(15, iArr, 0, iArr4, 0);
            camelliaEngine.f26587c[16] = iArr4[0];
            camelliaEngine.f26587c[17] = iArr4[1];
            m34889b(17, iArr, 0, camelliaEngine.f26589e, 0);
            m34889b(17, iArr, 0, camelliaEngine.f26587c, 8);
            m34889b(17, iArr, 0, camelliaEngine.f26587c, 0);
            camelliaEngine.f26587c[34] = iArr2[0];
            camelliaEngine.f26587c[35] = iArr2[1];
            camelliaEngine.f26587c[32] = iArr2[2];
            camelliaEngine.f26587c[33] = iArr2[3];
            m34889b(15, iArr2, 0, camelliaEngine.f26587c, 24);
            m34889b(15, iArr2, 0, camelliaEngine.f26589e, 4);
            m34889b(15, iArr2, 0, iArr4, 0);
            camelliaEngine.f26587c[18] = iArr4[2];
            camelliaEngine.f26587c[19] = iArr4[3];
            m34889b(15, iArr2, 0, camelliaEngine.f26587c, 12);
            m34893d(34, iArr2, 0, camelliaEngine.f26587c, 4);
            m34884a(17, iArr2, 0, camelliaEngine.f26588d, 0);
        }
    }

    /* renamed from: b */
    private int m34888b(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.f26590f[i3] = m34882a(bArr, (i3 * 4) + i);
            int[] iArr = this.f26590f;
            iArr[i3] = iArr[i3] ^ this.f26588d[i3];
        }
        m34886a(this.f26590f, this.f26587c, 0);
        m34886a(this.f26590f, this.f26587c, 4);
        m34886a(this.f26590f, this.f26587c, 8);
        m34890b(this.f26590f, this.f26589e, 0);
        m34886a(this.f26590f, this.f26587c, 12);
        m34886a(this.f26590f, this.f26587c, 16);
        m34886a(this.f26590f, this.f26587c, 20);
        m34890b(this.f26590f, this.f26589e, 4);
        m34886a(this.f26590f, this.f26587c, 24);
        m34886a(this.f26590f, this.f26587c, 28);
        m34886a(this.f26590f, this.f26587c, 32);
        bArr = this.f26590f;
        bArr[2] = this.f26588d[4] ^ bArr[2];
        bArr = this.f26590f;
        bArr[3] = bArr[3] ^ this.f26588d[5];
        bArr = this.f26590f;
        bArr[0] = bArr[0] ^ this.f26588d[6];
        bArr = this.f26590f;
        bArr[1] = bArr[1] ^ this.f26588d[7];
        m34883a(this.f26590f[2], bArr2, i2);
        m34883a(this.f26590f[3], bArr2, i2 + 4);
        m34883a(this.f26590f[0], bArr2, i2 + 8);
        m34883a(this.f26590f[1], bArr2, i2 + 12);
        return 16;
    }

    /* renamed from: c */
    private int m34891c(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.f26590f[i3] = m34882a(bArr, (i3 * 4) + i);
            int[] iArr = this.f26590f;
            iArr[i3] = iArr[i3] ^ this.f26588d[i3];
        ...
        m34886a(this.f26590f, this.f26587c, 28);
        m34886a(this.f26590f, this.f26587c, 32);
        m34890b(this.f26590f, this.f26589e, 8);
        m34886a(this.f26590f, this.f26587c, 36);
        m34886a(this.f26590f, this.f26587c, 40);
        m34886a(this.f26590f, this.f26587c, 44);
        bArr = this.f26590f;
        bArr[2] = bArr[2] ^ this.f26588d[4];
        bArr = this.f26590f;
        bArr[3] = bArr[3] ^ this.f26588d[5];
        bArr = this.f26590f;
        bArr[0] = bArr[0] ^ this.f26588d[6];
    ...
    public void mo5742a(boolean z, CipherParameters cipherParameters) {
        if (cipherParameters instanceof KeyParameter) {
            m34885a(z, ((KeyParameter) cipherParameters).m35685a());
            this.f26585a = true;
            return;
        }
    ...
    public int mo5740a(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        } else if (this.f26586b) {
            return m34888b(bArr, i, bArr2, i2);
        } else {
            return m34891c(bArr, i, bArr2, i2);
        }
    }
}
