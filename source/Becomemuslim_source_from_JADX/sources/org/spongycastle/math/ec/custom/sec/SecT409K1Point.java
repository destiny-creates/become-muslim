...
public class SecT409K1Point extends AbstractF2m {
    ...
    protected ECPoint mo6570e() {
        return new SecT409K1Point(null, m28409g(), m28410h());
    }
            ...
            if (!eCFieldElement4.mo6566j()) {
                if (k.mo6566j()) {
                    ...
                    if (eCFieldElement5.mo6566j()) {
                        return new SecT409K1Point(d, eCFieldElement5, d.m28384h(), this.f);
                    }
                    ...
                    if (eCFieldElement.mo6566j()) {
                        return new SecT409K1Point(d, eCFieldElement, d.m28384h(), this.f);
                    }
                ...
                return new SecT409K1Point(d, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{eCPoint}, this.f);
    ...
    public ECPoint mo6573u() {
        ...
        if (a.mo6566j()) {
            return new SecT409K1Point(d, a, d.m28384h(), this.f);
        }
        ...
        return new SecT409K1Point(d, e, eCFieldElement, new ECFieldElement[]{eCFieldElement5}, this.f);
    }
        ...
        if (!k.mo6566j()) {
            if (a.mo6565i()) {
                ...
                if (l.mo6566j()) {
                    ...
                    return new SecT409K1Point(d, eCFieldElement.mo6561e().mo6558c(k), eCFieldElement.mo6551a(l).mo6561e().mo6556b(a, eCFieldElement2, eCFieldElement.mo6558c(l).mo6558c(e2)), new ECFieldElement[]{eCPoint}, this.f);
                }
            }
        }
    ...
    public ECPoint mo6572t() {
        ...
        return new SecT409K1Point(eCCurve, eCFieldElement, eCFieldElement2.mo6551a(eCFieldElement3), eCFieldElementArr, this.f);
    }
}
