...
public class SecT131R1Point extends AbstractF2m {
    ...
    protected ECPoint mo6570e() {
        return new SecT131R1Point(null, m28409g(), m28410h());
    }
        ...
        if (!eCFieldElement.mo6566j()) {
            ...
            if (!eCFieldElement4.mo6566j()) {
                if (k.mo6566j()) {
                    ...
                    eCFieldElement5 = k.mo6561e().mo6551a(k).mo6551a(eCFieldElement).mo6551a(d.m28383g());
                    if (eCFieldElement5.mo6566j()) {
                        return new SecT131R1Point(d, eCFieldElement5, d.m28384h().mo6563g(), this.f);
                    }
                    ...
                    if (eCFieldElement.mo6566j()) {
                        return new SecT131R1Point(d, eCFieldElement, d.m28384h().mo6563g(), this.f);
                    }
                ...
                return new SecT131R1Point(d, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{eCPoint}, this.f);
    ...
    public ECPoint mo6573u() {
        ...
        boolean i = eCFieldElement5.mo6565i();
        if (i) {
            eCFieldElement2 = eCFieldElement4;
        } else {
            eCFieldElement2 = eCFieldElement4.mo6558c(eCFieldElement5);
        }
        if (i) {
            eCFieldElement3 = eCFieldElement5;
        } else {
            eCFieldElement3 = eCFieldElement5.mo6561e();
        }
        ECFieldElement g = d.m28383g();
        if (!i) {
            g = g.mo6558c(eCFieldElement3);
        }
        eCFieldElement4 = eCFieldElement4.mo6561e().mo6551a(eCFieldElement2).mo6551a(g);
        if (eCFieldElement4.mo6566j()) {
            return new SecT131R1Point(d, eCFieldElement4, d.m28384h().mo6563g(), this.f);
        }
        g = eCFieldElement4.mo6561e();
        if (i) {
            eCFieldElement3 = eCFieldElement4;
        } else {
            eCFieldElement3 = eCFieldElement4.mo6558c(eCFieldElement3);
        }
        if (!i) {
            eCFieldElement = eCFieldElement.mo6558c(eCFieldElement5);
        }
        ECFieldElement[] eCFieldElementArr = new ECFieldElement[]{eCFieldElement3};
        return new SecT131R1Point(d, g, eCFieldElement.mo6552a(eCFieldElement4, eCFieldElement2).mo6551a(g).mo6551a(eCFieldElement3), eCFieldElementArr, this.f);
    }
    ...
    public ECPoint mo6569c(ECPoint eCPoint) {
        ...
        if (!k.mo6566j()) {
            if (a.mo6565i()) {
                ...
                a = d.m28383g().mo6558c(e2).mo6551a(e).mo6551a(a.mo6558c(eCFieldElement2));
                eCFieldElement2 = l.mo6557c();
                eCFieldElement = d.m28383g().mo6551a(eCFieldElement2).mo6558c(e2).mo6551a(e).mo6556b(a, eCFieldElement, e2);
                k = k.mo6558c(e2);
                ...
                if (l.mo6566j()) {
                    ...
                    return new SecT131R1Point(d, eCFieldElement.mo6561e().mo6558c(k), eCFieldElement.mo6551a(l).mo6561e().mo6556b(a, eCFieldElement2, eCFieldElement.mo6558c(l).mo6558c(e2)), new ECFieldElement[]{eCPoint}, this.f);
                }
            }
        }
    ...
    public ECPoint mo6572t() {
        ...
        ECFieldElement[] eCFieldElementArr = new ECFieldElement[]{eCFieldElement3};
        return new SecT131R1Point(eCCurve, eCFieldElement, eCFieldElement2.mo6551a(eCFieldElement3), eCFieldElementArr, this.f);
    }
}
