...
public class SecT409K1Curve extends AbstractF2m {
    /* renamed from: i */
    protected SecT409K1Point f32111i;
    ...
    public SecT409K1Curve() {
        super(409, 87, 0, 0);
        this.f32111i = new SecT409K1Point(this, null, null);
        this.b = mo6541a(BigInteger.valueOf(0));
        this.c = mo6541a(BigInteger.valueOf(1));
        this.d = new BigInteger(1, Hex.m29436a("7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE5F83B2D4EA20400EC4557D5ED3E3E7CA5B4B5C83B8E01E5FCF"));
    ...
    protected ECPoint mo5903a(int i, BigInteger bigInteger) {
        ...
        if (a.mo6566j()) {
            ...
            ECFieldElement a2 = m41978a(a.mo6561e().mo6562f().mo6558c(this.c).mo6551a(this.b).mo6551a(a));
            if (a2 != null) {
                if (a2.mo6567k() != (i == 1)) {
                    a2 = a2.mo6557c();
                }
    ...
    /* renamed from: a */
    private ECFieldElement m41978a(ECFieldElement eCFieldElement) {
