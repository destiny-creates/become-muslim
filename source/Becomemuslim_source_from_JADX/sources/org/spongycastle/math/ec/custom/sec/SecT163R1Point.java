...
public class SecT163R1Point extends AbstractF2m {
    ...
    protected ECPoint mo6570e() {
        return new SecT163R1Point(null, m28409g(), m28410h());
    }
            ...
            if (!eCFieldElement4.mo6566j()) {
                if (k.mo6566j()) {
                    ...
                    if (eCFieldElement5.mo6566j()) {
                        return new SecT163R1Point(d, eCFieldElement5, d.m28384h().mo6563g(), this.f);
                    }
                    ...
                    if (eCFieldElement.mo6566j()) {
                        return new SecT163R1Point(d, eCFieldElement, d.m28384h().mo6563g(), this.f);
                    }
                ...
                return new SecT163R1Point(d, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{eCPoint}, this.f);
    ...
    public ECPoint mo6573u() {
        ...
        if (eCFieldElement4.mo6566j()) {
            return new SecT163R1Point(d, eCFieldElement4, d.m28384h().mo6563g(), this.f);
        }
        ...
        return new SecT163R1Point(d, g, eCFieldElement.mo6552a(eCFieldElement4, eCFieldElement2).mo6551a(g).mo6551a(eCFieldElement3), eCFieldElementArr, this.f);
    }
        ...
        if (!k.mo6566j()) {
            if (a.mo6565i()) {
                ...
                if (l.mo6566j()) {
                    ...
                    return new SecT163R1Point(d, eCFieldElement.mo6561e().mo6558c(k), eCFieldElement.mo6551a(l).mo6561e().mo6556b(a, eCFieldElement2, eCFieldElement.mo6558c(l).mo6558c(e2)), new ECFieldElement[]{eCPoint}, this.f);
                }
            }
        }
    ...
    public ECPoint mo6572t() {
        ...
        ECFieldElement[] eCFieldElementArr = new ECFieldElement[]{eCFieldElement3};
        return new SecT163R1Point(eCCurve, eCFieldElement, eCFieldElement2.mo6551a(eCFieldElement3), eCFieldElementArr, this.f);
    }
}
