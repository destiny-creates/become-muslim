...
public class SecT283K1Curve extends AbstractF2m {
    /* renamed from: i */
    protected SecT283K1Point f32108i;
    ...
    public SecT283K1Curve() {
        super(283, 5, 7, 12);
        this.f32108i = new SecT283K1Point(this, null, null);
        this.b = mo6541a(BigInteger.valueOf(0));
        this.c = mo6541a(BigInteger.valueOf(1));
        this.d = new BigInteger(1, Hex.m29436a("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE9AE2ED07577265DFF7F94451E061E163C61"));
    ...
    protected ECPoint mo5903a(int i, BigInteger bigInteger) {
        ...
        if (a.mo6566j()) {
            ...
            ECFieldElement a2 = m41924a(a.mo6561e().mo6562f().mo6558c(this.c).mo6551a(this.b).mo6551a(a));
            if (a2 != null) {
                if (a2.mo6567k() != (i == 1)) {
                    a2 = a2.mo6557c();
                }
    ...
    /* renamed from: a */
    private ECFieldElement m41924a(ECFieldElement eCFieldElement) {
