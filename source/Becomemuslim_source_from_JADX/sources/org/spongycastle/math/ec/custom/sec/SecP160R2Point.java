...
public class SecP160R2Point extends AbstractFp {
    ...
    protected ECPoint mo6570e() {
        return new SecP160R2Point(null, m28409g(), m28410h());
    }
    ...
    public ECPoint mo6568b(ECPoint eCPoint) {
        ...
        if (!Nat160.m28872b(a4)) {
            ...
            return new SecP160R2Point(d, secP160R2FieldElement7, secP160R2FieldElement8, new ECFieldElement[]{secP160R2FieldElement}, this.f);
    ...
    public ECPoint mo6573u() {
        ...
        int[] a2 = Nat160.m28868a();
        int[] a3 = Nat160.m28868a();
        SecP160R2Field.m28555d(secP160R2FieldElement.f32055b, a3);
        int[] a4 = Nat160.m28868a();
        SecP160R2Field.m28555d(a3, a4);
        boolean i = secP160R2FieldElement3.mo6565i();
        int[] iArr = secP160R2FieldElement3.f32055b;
        if (!i) {
            SecP160R2Field.m28555d(secP160R2FieldElement3.f32055b, a2);
            iArr = a2;
        }
        SecP160R2Field.m28556d(secP160R2FieldElement2.f32055b, iArr, a);
        SecP160R2Field.m28549a(secP160R2FieldElement2.f32055b, iArr, a2);
        SecP160R2Field.m28552b(a2, a, a2);
        SecP160R2Field.m28546a(Nat160.m28871b(a2, a2, a2), a2);
        SecP160R2Field.m28552b(a3, secP160R2FieldElement2.f32055b, a3);
        SecP160R2Field.m28546a(Nat.m29029c(5, a3, 2, 0), a3);
        SecP160R2Field.m28546a(Nat.m29005a(5, a4, 3, 0, a), a);
        ECFieldElement secP160R2FieldElement4 = new SecP160R2FieldElement(a4);
        SecP160R2Field.m28555d(a2, secP160R2FieldElement4.f32055b);
        SecP160R2Field.m28556d(secP160R2FieldElement4.f32055b, a3, secP160R2FieldElement4.f32055b);
        SecP160R2Field.m28556d(secP160R2FieldElement4.f32055b, a3, secP160R2FieldElement4.f32055b);
        ECFieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(a3);
        SecP160R2Field.m28556d(a3, secP160R2FieldElement4.f32055b, secP160R2FieldElement5.f32055b);
        SecP160R2Field.m28552b(secP160R2FieldElement5.f32055b, a2, secP160R2FieldElement5.f32055b);
        SecP160R2Field.m28556d(secP160R2FieldElement5.f32055b, a, secP160R2FieldElement5.f32055b);
        secP160R2FieldElement2 = new SecP160R2FieldElement(a2);
        ...
        return new SecP160R2Point(d, secP160R2FieldElement4, secP160R2FieldElement5, new ECFieldElement[]{secP160R2FieldElement2}, this.f);
    }
    ...
    public ECPoint mo6572t() {
        ...
        return new SecP160R2Point(this.b, this.c, this.d.mo6559d(), this.e, this.f);
    }
}
