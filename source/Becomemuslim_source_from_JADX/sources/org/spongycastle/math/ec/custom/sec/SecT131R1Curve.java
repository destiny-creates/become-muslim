...
public class SecT131R1Curve extends AbstractF2m {
    /* renamed from: i */
    protected SecT131R1Point f32093i;
    ...
    public SecT131R1Curve() {
        super(131, 2, 3, 8);
        this.f32093i = new SecT131R1Point(this, null, null);
        this.b = mo6541a(new BigInteger(1, Hex.m29436a("07A11B09A76B562144418FF3FF8C2570B8")));
        this.c = mo6541a(new BigInteger(1, Hex.m29436a("0217C05610884B63B9C6C7291678F9D341")));
        this.d = new BigInteger(1, Hex.m29436a("0400000000000000023123953A9464B54D"));
    ...
    protected ECPoint mo5903a(int i, BigInteger bigInteger) {
        ...
        if (a.mo6566j()) {
            ...
            ECFieldElement a2 = m41656a(a.mo6561e().mo6562f().mo6558c(this.c).mo6551a(this.b).mo6551a(a));
            if (a2 != null) {
                if (a2.mo6567k() != (i == 1)) {
                    a2 = a2.mo6557c();
                }
    ...
    /* renamed from: a */
    private ECFieldElement m41656a(ECFieldElement eCFieldElement) {
