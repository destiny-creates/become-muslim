...
public class SecT163R2Curve extends AbstractF2m {
    /* renamed from: i */
    protected SecT163R2Point f32098i;
    ...
    public SecT163R2Curve() {
        super(163, 3, 6, 7);
        this.f32098i = new SecT163R2Point(this, null, null);
        this.b = mo6541a(BigInteger.valueOf(1));
        this.c = mo6541a(new BigInteger(1, Hex.m29436a("020A601907B8C953CA1481EB10512F78744A3205FD")));
        this.d = new BigInteger(1, Hex.m29436a("040000000000000000000292FE77E70C12A4234C33"));
    ...
    protected ECPoint mo5903a(int i, BigInteger bigInteger) {
        ...
        if (a.mo6566j()) {
            ...
            ECFieldElement a2 = m41744a(a.mo6561e().mo6562f().mo6558c(this.c).mo6551a(this.b).mo6551a(a));
            if (a2 != null) {
                if (a2.mo6567k() != (i == 1)) {
                    a2 = a2.mo6557c();
                }
    ...
    /* renamed from: a */
    private ECFieldElement m41744a(ECFieldElement eCFieldElement) {
