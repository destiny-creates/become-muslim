...
*/
    ...
    L_0x0006:
        ...
        f1295a = r0;	 Catch:{ Exception -> 0x0014 }
        goto L_0x001b;
    L_0x0014:
        r0 = "ViewConfigCompat";
    ...
    L_0x001b:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.t.<clinit>():void");
    }

    /* renamed from: a */
    public static float m1733a(ViewConfiguration viewConfiguration, Context context) {
        if (VERSION.SDK_INT >= 26) {
            return viewConfiguration.getScaledHorizontalScrollFactor();
        }
        return C0518t.m1735c(viewConfiguration, context);
    }

    /* renamed from: b */
    public static float m1734b(ViewConfiguration viewConfiguration, Context context) {
        if (VERSION.SDK_INT >= 26) {
    ...
    /* renamed from: c */
    private static float m1735c(android.view.ViewConfiguration r3, android.content.Context r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x000a:
        r0 = f1295a;	 Catch:{ Exception -> 0x001b }
    ...
    L_0x0042:
        ...
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.t.c(android.view.ViewConfiguration, android.content.Context):float");
    }
}
