...
class C4453d extends C3164g {
    C4453d() {
    }

    /* renamed from: a */
    private java.io.File m14867a(android.os.ParcelFileDescriptor r4) {
...
*/
    ...
    /* renamed from: a */
    public android.graphics.Typeface mo170a(android.content.Context r5, android.os.CancellationSignal r6, android.support.v4.p031g.C0404b.C0402b[] r7, int r8) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0006:
        ...
        r7 = r7.m1188a();	 Catch:{ IOException -> 0x0077 }
        r0 = "r";	 Catch:{ IOException -> 0x0077 }
        r6 = r8.openFileDescriptor(r7, r0, r6);	 Catch:{ IOException -> 0x0077 }
        r7 = r4.m14867a(r6);	 Catch:{ Throwable -> 0x0060, all -> 0x005d }
    ...
    L_0x002f:
        ...
        r5 = super.m9406a(r5, r7);	 Catch:{ Throwable -> 0x0048, all -> 0x0045 }
    ...
    L_0x0077:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.a.d.a(android.content.Context, android.os.CancellationSignal, android.support.v4.g.b$b[], int):android.graphics.Typeface");
    }
}
