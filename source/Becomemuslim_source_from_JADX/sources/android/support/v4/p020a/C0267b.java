...
public class C0267b {
    ...
    public static class C0266b {
        ...
        C0266b(char c, float[] fArr) {
            this.f669a = c;
            this.f670b = fArr;
        }

        C0266b(C0266b c0266b) {
            this.f669a = c0266b.f669a;
            this.f670b = C0267b.m729a(c0266b.f670b, 0, c0266b.f670b.length);
        }

        /* renamed from: a */
        public static void m722a(C0266b[] c0266bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0266bArr.length; i++) {
                C0266b.m721a(path, fArr, c, c0266bArr[i].f669a, c0266bArr[i].f670b);
                c = c0266bArr[i].f669a;
            }
        }

        /* renamed from: a */
        public void m723a(C0266b c0266b, C0266b c0266b2, float f) {
            for (int i = 0; i < c0266b.f670b.length; i++) {
                this.f670b[i] = (c0266b.f670b[i] * (1.0f - f)) + (c0266b2.f670b[i] * f);
            }
        }
        ...
        /* renamed from: a */
        private static void m721a(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            /*
            r10 = r27;
            r13 = r31;
            r14 = 0;
        ...
        L_0x0185:
            ...
            r25 = r9;
            r9 = r26;
            android.support.v4.p020a.C0267b.C0266b.m720a(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            r0 = r13[r14];
            r8 = r11 + r0;
            r0 = r13[r15];
            r7 = r12 + r0;
        ...
        /* renamed from: a */
        private static void m720a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            float f8 = f;
            float f9 = f3;
            float f10 = f5;
            float f11 = f6;
            ...
            if (d14 < 0.0d) {
                ...
                C0266b.m720a(path, f, f2, f3, f4, f10 * f8, f6 * f8, f7, z, z2);
                return;
            }
            sin = Math.sqrt(d14);
            d7 *= sin;
            ...
            d11 *= d9;
            d12 *= d;
            C0266b.m719a(path, (d11 * cos) - (d12 * d13), (d11 * d13) + (d12 * cos), d9, d, d3, d5, toRadians, d6, atan2);
        }

        /* renamed from: a */
        private static void m719a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
    ...
    /* renamed from: a */
    static float[] m729a(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    /* renamed from: a */
    public static Path m725a(String str) {
        Path path = new Path();
        C0266b[] b = C0267b.m732b(str);
        if (b == null) {
            return null;
        }
        try {
    ...
    /* renamed from: b */
    public static C0266b[] m732b(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            i = C0267b.m724a(str, i);
            String trim = str.substring(i2, i).trim();
            if (trim.length() > 0) {
                C0267b.m727a(arrayList, trim.charAt(0), C0267b.m733c(trim));
            }
            i2 = i;
            i++;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0267b.m727a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0266b[]) arrayList.toArray(new C0266b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C0266b[] m730a(C0266b[] c0266bArr) {
        if (c0266bArr == null) {
            return null;
        }
        C0266b[] c0266bArr2 = new C0266b[c0266bArr.length];
        for (int i = 0; i < c0266bArr.length; i++) {
            c0266bArr2[i] = new C0266b(c0266bArr[i]);
        }
        return c0266bArr2;
    }

    /* renamed from: a */
    public static boolean m728a(C0266b[] c0266bArr, C0266b[] c0266bArr2) {
        if (c0266bArr != null) {
            if (c0266bArr2 != null) {
                if (c0266bArr.length != c0266bArr2.length) {
                    return false;
                }
                int i = 0;
                while (i < c0266bArr.length) {
                    if (c0266bArr[i].f669a == c0266bArr2[i].f669a) {
                        if (c0266bArr[i].f670b.length == c0266bArr2[i].f670b.length) {
                            i++;
                        }
                    }
                    return false;
    ...
    /* renamed from: b */
    public static void m731b(C0266b[] c0266bArr, C0266b[] c0266bArr2) {
        for (int i = 0; i < c0266bArr2.length; i++) {
            c0266bArr[i].f669a = c0266bArr2[i].f669a;
            for (int i2 = 0; i2 < c0266bArr2[i].f670b.length; i2++) {
                c0266bArr[i].f670b[i2] = c0266bArr2[i].f670b[i2];
            }
        }
    }

    /* renamed from: a */
    private static int m724a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static void m727a(ArrayList<C0266b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0266b(c, fArr));
    }

    /* renamed from: c */
    private static float[] m733c(String str) {
        if (str.charAt(0) != 'z') {
            if (str.charAt(0) != 'Z') {
                try {
                    ...
                    while (i < length) {
                        ...
                        i = c0265a.f668b ? i3 : i3 + 1;
                    }
                    return C0267b.m729a(fArr, 0, i2);
                } catch (Throwable e) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("error in parsing \"");
                    stringBuilder.append(str);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    private static void m726a(java.lang.String r8, int r9, android.support.v4.p020a.C0267b.C0265a r10) {
        /*
        r0 = 0;
        r10.f668b = r0;
        r1 = r9;
