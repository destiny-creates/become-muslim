...
public class al {
    /* renamed from: a */
    public static final Rect f1975a = new Rect();
    /* renamed from: b */
    private static Class<?> f1976b;
...
*/
    ...
    L_0x000d:
        ...
        f1976b = r0;	 Catch:{ ClassNotFoundException -> 0x0015 }
    L_0x0015:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.al.<clinit>():void");
    }

    /* renamed from: a */
    public static android.graphics.Rect m2613a(android.graphics.drawable.Drawable r10) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0004:
        r10 = android.support.v4.p020a.p021a.C0259a.m704h(r10);	 Catch:{ Exception -> 0x0098 }
    ...
    L_0x001d:
        ...
        r1 = f1976b;	 Catch:{ Exception -> 0x0098 }
    ...
    L_0x009f:
        ...
        return r10;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.al.a(android.graphics.drawable.Drawable):android.graphics.Rect");
    }

    /* renamed from: b */
    static void m2614b(Drawable drawable) {
    ...
    /* renamed from: c */
    public static boolean m2615c(Drawable drawable) {
        ...
        if (drawable instanceof DrawableContainer) {
            ...
            return m2615c(((C0262d) drawable).mo162a());
        } else {
            if (drawable instanceof C0633a) {
                return m2615c(((C0633a) drawable).m2120b());
            }
            if (drawable instanceof ScaleDrawable) {
                return m2615c(((ScaleDrawable) drawable).getDrawable());
            }
        }
        return true;
    }
    ...
    /* renamed from: d */
    private static void m2616d(Drawable drawable) {
        int[] state = drawable.getState();
        if (state != null) {
            if (state.length != 0) {
                drawable.setState(bl.f2126h);
                drawable.setState(state);
            }
        }
        drawable.setState(bl.f2123e);
        drawable.setState(state);
    }

    /* renamed from: a */
    public static Mode m2612a(int i, Mode mode) {
        if (i == 3) {
