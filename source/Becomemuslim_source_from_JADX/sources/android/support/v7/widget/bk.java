...
import android.support.v7.p042f.C0637a;
...
public class bk extends CompoundButton {
    ...
    private static final Property<bk, Float> THUMB_POS = new Property<bk, Float>(Float.class, "thumbPos") {
        public /* synthetic */ Object get(Object obj) {
            return m2755a((bk) obj);
        }

        public /* synthetic */ void set(Object obj, Object obj2) {
            m2756a((bk) obj, (Float) obj2);
        }

        /* renamed from: a */
        public Float m2755a(bk bkVar) {
            return Float.valueOf(bkVar.mThumbPosition);
        }

        /* renamed from: a */
        public void m2756a(bk bkVar, Float f) {
            bkVar.setThumbPosition(f.floatValue());
        }
    };
    ...
    public bk(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0581a.switchStyle);
    }
    ...
    public bk(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = bq.m2769a(context, attributeSet, C0590j.SwitchCompat, i, 0);
        this.mThumbDrawable = attributeSet.m2773a(C0590j.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != 0) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = attributeSet.m2773a(C0590j.SwitchCompat_track);
        if (this.mTrackDrawable != 0) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = attributeSet.m2779c(C0590j.SwitchCompat_android_textOn);
        this.mTextOff = attributeSet.m2779c(C0590j.SwitchCompat_android_textOff);
        this.mShowText = attributeSet.m2775a(C0590j.SwitchCompat_showText, true);
        this.mThumbTextPadding = attributeSet.m2782e(C0590j.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = attributeSet.m2782e(C0590j.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = attributeSet.m2782e(C0590j.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = attributeSet.m2775a(C0590j.SwitchCompat_splitTrack, false);
        i = attributeSet.m2783e(C0590j.SwitchCompat_thumbTint);
        if (i != 0) {
            this.mThumbTintList = i;
            this.mHasThumbTint = true;
        }
        i = al.m2612a(attributeSet.m2771a(C0590j.SwitchCompat_thumbTintMode, -1), null);
        ...
        i = attributeSet.m2783e(C0590j.SwitchCompat_trackTint);
        if (i != 0) {
            this.mTrackTintList = i;
            this.mHasTrackTint = true;
        }
        i = al.m2612a(attributeSet.m2771a(C0590j.SwitchCompat_trackTintMode, -1), null);
        ...
        i = attributeSet.m2786g(C0590j.SwitchCompat_switchTextAppearance, 0);
        if (i != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        context = bq.m2767a(context, i, C0590j.TextAppearance);
        i = context.m2783e(C0590j.TextAppearance_android_textColor);
        if (i != 0) {
            this.mTextColors = i;
        } else {
            this.mTextColors = getTextColors();
        }
        i = context.m2782e(C0590j.TextAppearance_android_textSize, 0);
        if (i != 0) {
            i = (float) i;
        ...
        setSwitchTypefaceByIndex(context.m2771a(C0590j.TextAppearance_android_typeface, -1), context.m2771a(C0590j.TextAppearance_android_textStyle, -1));
        if (context.m2775a(C0590j.TextAppearance_textAllCaps, false) != 0) {
            this.mSwitchTransformationMethod = new C0637a(getContext());
        } else {
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(C0631b.m2112b(getContext(), i));
    }
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                C0259a.m692a(this.mTrackDrawable, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                C0259a.m695a(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(C0631b.m2112b(getContext(), i));
    }
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                C0259a.m692a(this.mThumbDrawable, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                C0259a.m695a(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i4 = rect.right;
        if (this.mThumbDrawable != null) {
            Rect a = al.m2613a(this.mThumbDrawable);
    ...
    L_0x0031:
        r4 = android.support.v7.widget.by.m2841a(r6);
        r5 = 0;
    ...
    L_0x0050:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.bk.stopDrag(android.view.MotionEvent):void");
    }
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        z = isChecked();
        if (getWindowToken() == null || !C0517s.m1730x(this)) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable) {
            ...
            i2 = al.m2613a(this.mThumbDrawable);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            a = al.m2613a(this.mThumbDrawable);
        } else {
            a = al.f1975a;
        }
        if (this.mTrackDrawable != null) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (background != null) {
                C0259a.m691a(background, i, i2, thumbOffset, i4);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            C0259a.m689a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            C0259a.m689a(this.mTrackDrawable, f, f2);
        }
    }
