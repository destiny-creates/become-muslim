...
class C0258z {
    /* renamed from: a */
    static View m687a(ViewGroup viewGroup, View view, View view2) {
        Matrix matrix = new Matrix();
        matrix.setTranslate((float) (-view2.getScrollX()), (float) (-view2.getScrollY()));
        am.m579a(view, matrix);
        am.m581b(viewGroup, matrix);
        ...
        viewGroup = C0258z.m686a(view, matrix, rectF);
        if (viewGroup != null) {
    ...
    /* renamed from: a */
    private static Bitmap m686a(View view, Matrix matrix, RectF rectF) {
    ...
    /* renamed from: a */
    static Animator m685a(Animator animator, Animator animator2) {
        if (animator == null) {
            return animator2;
        }
        if (animator2 == null) {
