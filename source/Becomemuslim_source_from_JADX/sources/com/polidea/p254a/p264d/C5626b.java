...
/* compiled from: StandardUUIDsParser */
/* renamed from: com.polidea.a.d.b */
public class C5626b {
    /* renamed from: a */
    private static final Map<String, String> f18799a;
    /* renamed from: b */
    private static final Map<String, String> f18800b;
    /* renamed from: c */
    private static final Map<String, String> f18801c;
    ...
    static {
        ...
        f18799a = Collections.unmodifiableMap(hashMap);
        hashMap = new HashMap();
        ...
        f18800b = Collections.unmodifiableMap(hashMap);
        hashMap = new HashMap();
        ...
        f18801c = Collections.unmodifiableMap(hashMap);
    }

    /* renamed from: a */
    public static String m23921a(UUID uuid) {
        uuid = C5626b.m23925d(uuid);
        return uuid != null ? (String) f18799a.get(uuid) : null;
    }

    /* renamed from: b */
    public static String m23923b(UUID uuid) {
        uuid = C5626b.m23925d(uuid);
        return uuid != null ? (String) f18800b.get(uuid) : null;
    }

    /* renamed from: c */
    public static String m23924c(UUID uuid) {
        uuid = C5626b.m23925d(uuid);
        return uuid != null ? (String) f18801c.get(uuid) : null;
    }

    /* renamed from: d */
    private static String m23925d(UUID uuid) {
        String toUpperCase = uuid.toString().toUpperCase();
        return C5626b.m23922a(toUpperCase) ? toUpperCase.substring(4, 8) : null;
    }

    /* renamed from: a */
    private static boolean m23922a(String str) {
        return (!str.startsWith("0000") || str.endsWith("-0000-1000-8000-00805F9B34FB") == null) ? null : true;
    }
}
