...
final class C5233a {
    ...
    byte[] m22167a() {
        ...
        int g = this.f17671b.m22011g();
        int f = this.f17671b.m22010f();
        int i = 0;
        while (i < g) {
            int[] iArr = f17670a[i];
            int i2 = 0;
            while (i2 < f) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f17671b.m22002a(i2, i)) {
                    int i4 = i3 / 6;
