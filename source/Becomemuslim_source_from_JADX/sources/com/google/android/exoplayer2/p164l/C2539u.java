...
/* renamed from: com.google.android.exoplayer2.l.u */
public final class C2539u {
    /* renamed from: a */
    public static Uri m7158a(String str, String str2) {
        return Uri.parse(C2539u.m7161b(str, str2));
    }

    /* renamed from: b */
    public static String m7161b(String str, String str2) {
        ...
        int[] a = C2539u.m7160a(str2);
        if (a[0] != -1) {
            stringBuilder.append(str2);
            C2539u.m7159a(stringBuilder, a[1], a[2]);
            return stringBuilder.toString();
        }
        int[] a2 = C2539u.m7160a(str);
        if (a[3] == 0) {
            ...
            stringBuilder.append(str2);
            return C2539u.m7159a(stringBuilder, a[1] + i, i + a[2]);
        } else if (str2.charAt(a[1]) == '/') {
            stringBuilder.append(str, 0, a2[1]);
            stringBuilder.append(str2);
            return C2539u.m7159a(stringBuilder, a2[1], a2[1] + a[2]);
            ...
            stringBuilder.append(str2);
            return C2539u.m7159a(stringBuilder, a2[1], i2 + a[2]);
        } else {
            stringBuilder.append(str, 0, a2[1]);
            stringBuilder.append('/');
            stringBuilder.append(str2);
            return C2539u.m7159a(stringBuilder, a2[1], (a2[1] + a[2]) + 1);
        }
    }

    /* renamed from: a */
    private static String m7159a(StringBuilder stringBuilder, int i, int i2) {
        if (i >= i2) {
            return stringBuilder.toString();
        }
    ...
    /* renamed from: a */
    private static int[] m7160a(String str) {
        int[] iArr = new int[4];
