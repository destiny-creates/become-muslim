...
public final class agc {
    /* renamed from: a */
    private static String f14446a;

    /* renamed from: a */
    public static String m18398a(Context context) {
        if (f14446a != null) {
            return f14446a;
        }
        ...
        if (arrayList.isEmpty()) {
            ...
            } else if (!TextUtils.isEmpty(obj) && !m18399a(context, intent) && arrayList.contains(obj)) {
                f14446a = obj;
    ...
    /* renamed from: a */
    private static boolean m18399a(android.content.Context r3, android.content.Intent r4) {
...
*/
    ...
    L_0x0042:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.agc.a(android.content.Context, android.content.Intent):boolean");
    }
}
