...
import com.google.android.gms.auth.api.signin.internal.C4755y;
    ...
    public final IBinder onBind(Intent intent) {
        if (!"com.google.android.gms.auth.api.signin.RevocationBoundService.disconnect".equals(intent.getAction())) {
            if (!"com.google.android.gms.auth.api.signin.RevocationBoundService.clearClientState".equals(intent.getAction())) {
                ...
                Log.w(str, intent.length() != 0 ? str2.concat(intent) : new String(str2));
                return null;
            }
        }
        if (Log.isLoggable("RevocationService", 2)) {
            ...
            intent = String.valueOf(intent.getAction());
            Log.v(str, intent.length() != 0 ? str2.concat(intent) : new String(str2));
        }
        return new C4755y(this);
    }
}
