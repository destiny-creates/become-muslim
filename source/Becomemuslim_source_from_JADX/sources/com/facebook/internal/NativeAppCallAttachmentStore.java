    ...
    public static final class Attachment {
        ...
        private Attachment(UUID uuid, Bitmap bitmap, Uri uri) {
            ...
            if (uri != null) {
                ...
                if (UriUtil.LOCAL_CONTENT_SCHEME.equalsIgnoreCase(bitmap)) {
                    this.isContentUri = true;
                    if (uri.getAuthority() == null || uri.getAuthority().startsWith("media") != null) {
                        z = false;
                    }
            ...
            if (this.shouldCreateFile == null) {
                uuid = this.originalUri.toString();
            } else {
                uuid = FacebookContentProvider.getAttachmentUrl(FacebookSdk.getApplicationId(), uuid, this.attachmentName);
            }
            this.attachmentUrl = uuid;
        }
...
*/
    ...
    L_0x0023:
        ...
        r1 = (com.facebook.internal.NativeAppCallAttachmentStore.Attachment) r1;	 Catch:{ IOException -> 0x0061 }
        r2 = r1.shouldCreateFile;	 Catch:{ IOException -> 0x0061 }
        if (r2 != 0) goto L_0x0030;	 Catch:{ IOException -> 0x0061 }
    L_0x002f:
        goto L_0x001d;	 Catch:{ IOException -> 0x0061 }
    L_0x0030:
        r2 = r1.callId;	 Catch:{ IOException -> 0x0061 }
        r3 = r1.attachmentName;	 Catch:{ IOException -> 0x0061 }
        r4 = 1;	 Catch:{ IOException -> 0x0061 }
        r2 = getAttachmentFile(r2, r3, r4);	 Catch:{ IOException -> 0x0061 }
        r0.add(r2);	 Catch:{ IOException -> 0x0061 }
        r3 = r1.bitmap;	 Catch:{ IOException -> 0x0061 }
        if (r3 == 0) goto L_0x004e;	 Catch:{ IOException -> 0x0061 }
    L_0x0046:
        r1 = r1.bitmap;	 Catch:{ IOException -> 0x0061 }
        processAttachmentBitmap(r1, r2);	 Catch:{ IOException -> 0x0061 }
        goto L_0x001d;	 Catch:{ IOException -> 0x0061 }
    L_0x004e:
        r3 = r1.originalUri;	 Catch:{ IOException -> 0x0061 }
        if (r3 == 0) goto L_0x001d;	 Catch:{ IOException -> 0x0061 }
    L_0x0054:
        r3 = r1.originalUri;	 Catch:{ IOException -> 0x0061 }
        r1 = r1.isContentUri;	 Catch:{ IOException -> 0x0061 }
        processAttachmentFile(r3, r1, r2);	 Catch:{ IOException -> 0x0061 }
        goto L_0x001d;
    L_0x0060:
        return;
    L_0x0061:
    ...
    public static java.io.File openAttachment(java.util.UUID r1, java.lang.String r2) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0008:
        r0 = 0;
        r1 = getAttachmentFile(r1, r2, r0);	 Catch:{ IOException -> 0x000e }
        return r1;
    L_0x000e:
    ...
    static java.io.File getAttachmentFile(java.util.UUID r2, java.lang.String r3, boolean r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
