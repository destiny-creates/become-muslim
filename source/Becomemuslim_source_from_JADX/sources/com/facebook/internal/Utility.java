...
public final class Utility {
    ...
    static class C18122 implements FilenameFilter {
        C18122() {
        }
    ...
    public static <T> boolean isSubset(Collection<T> collection, Collection<T> collection2) {
        ...
        if (collection == null || collection.size() == null) {
            z = true;
        }
        return z;
    }
...
*/
    ...
    public static void setAppEventExtendedDeviceInfoParameters(org.json.JSONObject r7, android.content.Context r8) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
        ...
        r1 = "a2";
        r0.put(r1);
        refreshPeriodicExtendedDeviceInfo(r8);
    ...
    L_0x0091:
        ...
        r0.put(r8);
        r8 = refreshBestGuessNumberOfCPUCores();
        r0.put(r8);
        r1 = totalExternalStorageGB;
        r0.put(r1);
        r1 = availableExternalStorageGB;
        r0.put(r1);
        r8 = deviceTimeZoneName;
        r0.put(r8);
        r8 = "extinfo";
        r0 = r0.toString();
        r7.put(r8, r0);
...
*/
    ...
    public static boolean isWebUri(Uri uri) {
        return (uri == null || !(UriUtil.HTTP_SCHEME.equalsIgnoreCase(uri.getScheme()) || "https".equalsIgnoreCase(uri.getScheme()) || "fbstaging".equalsIgnoreCase(uri.getScheme()) != null)) ? null : true;
    }

    public static boolean isContentUri(Uri uri) {
        return (uri == null || UriUtil.LOCAL_CONTENT_SCHEME.equalsIgnoreCase(uri.getScheme()) == null) ? null : true;
    }

    public static boolean isFileUri(Uri uri) {
        return (uri == null || UriUtil.LOCAL_FILE_SCHEME.equalsIgnoreCase(uri.getScheme()) == null) ? null : true;
    }
...
*/
    ...
    private static void refreshPeriodicExtendedDeviceInfo(Context context) {
        if (timestampOfLastCheck == -1 || System.currentTimeMillis() - timestampOfLastCheck >= Constants.SESSION_TIMEOUT_MILLIS) {
...
*/
        ...
        deviceTimezoneAbbreviation = r1;	 Catch:{ AssertionError -> 0x001a, AssertionError -> 0x001a }
        r0 = r0.getID();	 Catch:{ AssertionError -> 0x001a, AssertionError -> 0x001a }
        deviceTimeZoneName = r0;	 Catch:{ AssertionError -> 0x001a, AssertionError -> 0x001a }
    L_0x001a:
        return;
        */
...
*/
    ...
    L_0x000a:
        ...
        carrierName = r2;	 Catch:{ Exception -> 0x0018 }
    L_0x0018:
        return;
        */
...
*/
    ...
    public static PermissionsPair handlePermissionResponse(JSONObject jSONObject) {
        jSONObject = jSONObject.getJSONObject(NativeProtocol.RESULT_ARGS_PERMISSIONS).getJSONArray("data");
    ...
    public static boolean isChromeOS(Context context) {
        ...
        return (Build.DEVICE == null || Build.DEVICE.matches(ARC_DEVICE_PATTERN) == null) ? null : true;
    }
...
*/
        /*
        r0 = com.facebook.FacebookSdk.getApplicationContext();	 Catch:{ Exception -> 0x000f }
