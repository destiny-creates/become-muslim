...
public interface ReactShadowNode<T extends ReactShadowNode> {
    ...
    ReactShadowNode getOriginalReactShadowNode();
    ...
    T mutableCopy(long j);

    T mutableCopyWithNewChildren(long j);

    T mutableCopyWithNewChildrenAndProps(long j, ReactStylesDiffMap reactStylesDiffMap);

    T mutableCopyWithNewProps(long j, ReactStylesDiffMap reactStylesDiffMap);
    ...
    void setOriginalReactShadowNode(ReactShadowNode reactShadowNode);
    ...
    void updateScreenLayout(ReactShadowNode reactShadowNode);
}
