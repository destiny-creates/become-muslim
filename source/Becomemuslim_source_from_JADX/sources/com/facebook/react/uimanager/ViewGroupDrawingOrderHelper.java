...
public class ViewGroupDrawingOrderHelper {
    ...
    class C19701 implements Comparator<View> {
        C19701() {
        }
        ...
        public int compare(View view, View view2) {
            ...
            view2 = ViewGroupManager.getViewZIndex(view2);
            if (view2 == null) {
                view2 = Integer.valueOf(0);
            }
            return view.intValue() - view2.intValue();
        }
    }
    ...
    public int getChildDrawingOrder(int i, int i2) {
        if (this.mDrawingOrderIndices == null) {
            ...
            Collections.sort(arrayList, new C19701());
