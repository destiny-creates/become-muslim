...
import android.support.v4.widget.C3244q;
...
public class ReactSwipeRefreshLayout extends C3244q {
    ...
    private boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            motionEvent = Math.abs(motionEvent.getX() - this.mPrevTouchX);
            if (this.mIntercepted || motionEvent > ((float) this.mTouchSlop)) {
