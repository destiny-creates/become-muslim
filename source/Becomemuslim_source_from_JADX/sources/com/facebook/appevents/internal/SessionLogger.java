...
class SessionLogger {
    private static final long[] INACTIVE_SECONDS_QUANTA = new long[]{Constants.MIN_TIME_BETWEEN_SESSIONS_MILLIS, 900000, Constants.SESSION_TIMEOUT_MILLIS, 3600000, 21600000, 43200000, 86400000, 172800000, 259200000, 604800000, 1209600000, 1814400000, 2419200000L, 5184000000L, 7776000000L, 10368000000L, 12960000000L, 15552000000L, 31536000000L};
    ...
    public static void logActivateApp(String str, SourceApplicationInfo sourceApplicationInfo, String str2) {
        sourceApplicationInfo = sourceApplicationInfo != null ? sourceApplicationInfo.toString() : "Unclassified";
        Bundle bundle = new Bundle();
        bundle.putString(AppEventsConstants.EVENT_PARAM_SOURCE_APPLICATION, sourceApplicationInfo);
        sourceApplicationInfo = new InternalAppEventsLogger(str, str2, null);
        sourceApplicationInfo.logEvent(AppEventsConstants.EVENT_NAME_ACTIVATED_APP, bundle);
        if (AppEventsLogger.getFlushBehavior() != FlushBehavior.EXPLICIT_ONLY) {
            sourceApplicationInfo.flush();
        }
    }
