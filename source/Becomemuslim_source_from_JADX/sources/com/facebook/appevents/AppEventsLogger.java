...
public class AppEventsLogger {
    ...
    static class C16975 implements Runnable {
        C16975() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C16981();
        ...
        static class C16981 implements Runnable {
            C16981() {
            }
...
*/
        ...
        L_0x0007:
            ...
            r5 = "AppEventsLogger.persistedsessioninfo";	 Catch:{ FileNotFoundException -> 0x0095, Exception -> 0x0046, all -> 0x0041 }
            ...
            r5 = "AppEvents";	 Catch:{ FileNotFoundException -> 0x0096, Exception -> 0x003f }
            r6 = "App session info loaded";	 Catch:{ FileNotFoundException -> 0x0096, Exception -> 0x003f }
            ...
            r3 = "AppEventsLogger.persistedsessioninfo";	 Catch:{ all -> 0x00ae }
            r9.deleteFile(r3);	 Catch:{ all -> 0x00ae }
            r9 = appSessionInfoMap;	 Catch:{ all -> 0x00ae }
            if (r9 != 0) goto L_0x0039;	 Catch:{ all -> 0x00ae }
        L_0x0032:
        ...
        L_0x004a:
            ...
            r7 = "Got unexpected exception restoring app session info: ";	 Catch:{ all -> 0x007c }
            ...
            r9.deleteFile(r3);	 Catch:{ all -> 0x00ae }
            r9 = appSessionInfoMap;	 Catch:{ all -> 0x00ae }
            if (r9 != 0) goto L_0x0079;	 Catch:{ all -> 0x00ae }
        L_0x0072:
            r9 = new java.util.HashMap;	 Catch:{ all -> 0x00ae }
            r9.<init>();	 Catch:{ all -> 0x00ae }
            appSessionInfoMap = r9;	 Catch:{ all -> 0x00ae }
        L_0x0079:
            isLoaded = r2;	 Catch:{ all -> 0x00ae }
            goto L_0x003b;	 Catch:{ all -> 0x00ae }
        L_0x007c:
            r3 = move-exception;	 Catch:{ all -> 0x00ae }
        L_0x007d:
            com.facebook.internal.Utility.closeQuietly(r4);	 Catch:{ all -> 0x00ae }
            r4 = "AppEventsLogger.persistedsessioninfo";	 Catch:{ all -> 0x00ae }
            r9.deleteFile(r4);	 Catch:{ all -> 0x00ae }
            r9 = appSessionInfoMap;	 Catch:{ all -> 0x00ae }
            if (r9 != 0) goto L_0x0090;	 Catch:{ all -> 0x00ae }
        L_0x0089:
            r9 = new java.util.HashMap;	 Catch:{ all -> 0x00ae }
            r9.<init>();	 Catch:{ all -> 0x00ae }
            appSessionInfoMap = r9;	 Catch:{ all -> 0x00ae }
        ...
        L_0x0095:
            r4 = r3;	 Catch:{ all -> 0x00ae }
        L_0x0096:
            com.facebook.internal.Utility.closeQuietly(r4);	 Catch:{ all -> 0x00ae }
            r3 = "AppEventsLogger.persistedsessioninfo";	 Catch:{ all -> 0x00ae }
            r9.deleteFile(r3);	 Catch:{ all -> 0x00ae }
            r9 = appSessionInfoMap;	 Catch:{ all -> 0x00ae }
            if (r9 != 0) goto L_0x00a9;	 Catch:{ all -> 0x00ae }
        L_0x00a2:
            r9 = new java.util.HashMap;	 Catch:{ all -> 0x00ae }
            r9.<init>();	 Catch:{ all -> 0x00ae }
            appSessionInfoMap = r9;	 Catch:{ all -> 0x00ae }
        ...
        L_0x00ac:
            ...
            return;	 Catch:{ all -> 0x00ae }
        L_0x00ae:
            r9 = move-exception;	 Catch:{ all -> 0x00ae }
            monitor-exit(r0);	 Catch:{ all -> 0x00ae }
            throw r9;
            */
...
*/
                ...
                L_0x0042:
                    r2 = "com.facebook.marketing.Marketing";	 Catch:{ ClassNotFoundException -> 0x004c }
                    java.lang.Class.forName(r2);	 Catch:{ ClassNotFoundException -> 0x004c }
                    r2 = "marketing_lib_included";	 Catch:{ ClassNotFoundException -> 0x004c }
                    r0.putInt(r2, r1);	 Catch:{ ClassNotFoundException -> 0x004c }
                L_0x004c:
                    r2 = "com.facebook.all.All";	 Catch:{ ClassNotFoundException -> 0x0056 }
                    java.lang.Class.forName(r2);	 Catch:{ ClassNotFoundException -> 0x0056 }
                    r2 = "all_lib_included";	 Catch:{ ClassNotFoundException -> 0x0056 }
                    r0.putInt(r2, r1);	 Catch:{ ClassNotFoundException -> 0x0056 }
                L_0x0056:
                    r2 = "com.android.billingclient.api.BillingClient";	 Catch:{ ClassNotFoundException -> 0x0060 }
                    java.lang.Class.forName(r2);	 Catch:{ ClassNotFoundException -> 0x0060 }
                    r2 = "billing_client_lib_included";	 Catch:{ ClassNotFoundException -> 0x0060 }
                    r0.putInt(r2, r1);	 Catch:{ ClassNotFoundException -> 0x0060 }
                L_0x0060:
                    r2 = "com.android.vending.billing.IInAppBillingService";	 Catch:{ ClassNotFoundException -> 0x006a }
                    java.lang.Class.forName(r2);	 Catch:{ ClassNotFoundException -> 0x006a }
                    r2 = "billing_service_lib_included";	 Catch:{ ClassNotFoundException -> 0x006a }
                ...
                L_0x006a:
                    ...
                    return;
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.AppEventsLogger.3.run():void");
                }
            });
        }
    }
    ...
    public void logPurchaseImplicitly(BigDecimal bigDecimal, Currency currency, Bundle bundle) {
        bigDecimal = "Function logPurchaseImplicitly() is deprecated and your purchase events cannot be logged with this function. ";
        if (AutomaticAnalyticsLogger.isImplicitPurchaseLoggingEnabled() != null) {
            currency = new StringBuilder();
            currency.append(bigDecimal);
            currency.append("Auto-logging of in-app purchase has been enabled in the SDK, so you don't have to manually log purchases");
            bigDecimal = currency.toString();
        } else {
            currency = new StringBuilder();
            currency.append(bigDecimal);
            currency.append("Please use logPurchase() function instead.");
            bigDecimal = currency.toString();
        }
...
*/
    ...
    public static void setPushNotificationsRegistrationId(String str) {
        synchronized (staticLock) {
            if (!Utility.stringsEqualOrEmpty(pushNotificationsRegistrationId, str)) {
                ...
                str = newLogger(FacebookSdk.getApplicationContext());
                str.logEvent(AppEventsConstants.EVENT_NAME_PUSH_TOKEN_OBTAINED);
    ...
    public static void augmentWebView(WebView webView, Context context) {
        ...
        if (VERSION.SDK_INT >= 17 && parseInt >= 4) {
            if (parseInt != 4 || r2 > 1) {
                FacebookSDKJSInterface facebookSDKJSInterface = new FacebookSDKJSInterface(context);
                context = new StringBuilder();
                context.append("fbmq_");
                context.append(FacebookSdk.getApplicationId());
                webView.addJavascriptInterface(facebookSDKJSInterface, context.toString());
                return;
            }
        }
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C16975(), 0, 86400, TimeUnit.SECONDS);
        }
    }

    protected void logEventImplicitly(String str, BigDecimal bigDecimal, Currency currency, Bundle bundle) {
    ...
    private static void logEvent(AppEvent appEvent, AccessTokenAppIdPair accessTokenAppIdPair) {
        ...
        if (appEvent.getName().equals(AppEventsConstants.EVENT_NAME_ACTIVATED_APP) != null) {
