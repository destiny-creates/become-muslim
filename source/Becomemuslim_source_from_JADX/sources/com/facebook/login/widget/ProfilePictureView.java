...
public class ProfilePictureView extends FrameLayout {
    ...
    class C37841 implements Callback {
        C37841() {
        }
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        attributeSet = getContext().obtainStyledAttributes(attributeSet, C1833R.styleable.com_facebook_profile_picture_view);
        setPresetSize(attributeSet.getInt(C1833R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = attributeSet.getBoolean(C1833R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, IS_CROPPED_DEFAULT_VALUE);
    ...
    private void setBlankProfilePicture() {
        ...
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C1833R.drawable.com_facebook_profile_picture_blank_square : C1833R.drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private void sendImageRequest(boolean z) {
        z = new Builder(getContext(), ImageRequest.getProfilePictureUri(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(z).setCallerTag(this).setCallback(new C37841()).build();
        if (this.lastRequest != null) {
            ImageDownloader.cancelRequest(this.lastRequest);
        }
        this.lastRequest = z;
    ...
    private int getPresetSizeInPixels(boolean z) {
        switch (this.presetSizeType) {
            case LARGE /*-4*/:
                z = C1833R.dimen.com_facebook_profilepictureview_preset_size_large;
                break;
            case NORMAL /*-3*/:
                z = C1833R.dimen.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                z = C1833R.dimen.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (z) {
                    z = C1833R.dimen.com_facebook_profilepictureview_preset_size_normal;
