...
*/
    ...
    L_0x001a:
        ...
        r1.facebookVersion = r2;	 Catch:{ NameNotFoundException -> 0x001e }
    L_0x001e:
        return;
        */
...
*/
    ...
    public void logLoginStatusSuccess(String str) {
        str = newAuthorizationLoggingBundle(str);
        str.putString(EVENT_PARAM_LOGIN_RESULT, Code.SUCCESS.getLoggingValue());
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_STATUS_COMPLETE, null, str);
    }

    public void logLoginStatusFailure(String str) {
        str = newAuthorizationLoggingBundle(str);
        str.putString(EVENT_PARAM_LOGIN_RESULT, EVENT_EXTRAS_FAILURE);
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_STATUS_COMPLETE, null, str);
    }

    public void logLoginStatusError(String str, Exception exception) {
        str = newAuthorizationLoggingBundle(str);
        str.putString(EVENT_PARAM_LOGIN_RESULT, Code.ERROR.getLoggingValue());
        str.putString(EVENT_PARAM_ERROR_MESSAGE, exception.toString());
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_STATUS_COMPLETE, null, str);
    }
