...
public final class Document extends ThreadBoundProxy {
    ...
    class C20591 implements Runnable {
        C20591() {
        }
    ...
    private void init() {
        ...
        this.mDocumentProvider.postAndWait(new C20591());
    }

    private void cleanUp() {
        this.mDocumentProvider.postAndWait(new C20602());
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m5743e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    private void applyDocumentUpdate(final Update update) {
        ...
        update.getChangedElements(new Accumulator<Object>() {
            private Accumulator<Object> insertedElements = new C39541();
            ...
            class C39541 implements Accumulator<Object> {
                C39541() {
                }

                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C39555.this.listenerInsertedElements.add(obj);
                    }
                }
            }
