...
public final class ShareApi {
    ...
    class C39027 implements ValueMapper {
        C39027() {
        }
...
*/
    ...
    private void shareOpenGraphContent(ShareOpenGraphContent shareOpenGraphContent, final FacebookCallback<Result> facebookCallback) {
        final Callback c38981 = new Callback() {
        ...
        stageOpenGraphAction(bundle, new OnMapperCompleteListener() {
            public void onComplete() {
                try {
                    ...
                    new GraphRequest(AccessToken.getCurrentAccessToken(), ShareApi.this.getGraphPath(URLEncoder.encode(action.getActionType(), "UTF-8")), bundle2, HttpMethod.POST, c38981).executeAsync();
                } catch (Exception e) {
...
*/
    ...
    L_0x0040:
        ...
        r0 = "image";	 Catch:{ JSONException -> 0x004d }
    ...
    private void sharePhotoContent(com.facebook.share.model.SharePhotoContent r18, com.facebook.FacebookCallback<com.facebook.share.Sharer.Result> r19) {
        /*
        r17 = this;
        r7 = r17;
        r8 = r19;
        r0 = new com.facebook.internal.Mutable;
        r1 = 0;
        r1 = java.lang.Integer.valueOf(r1);
        r0.<init>(r1);
        r15 = com.facebook.AccessToken.getCurrentAccessToken();
        ...
        r4.<init>();
        r16 = new com.facebook.share.ShareApi$3;
        r1 = r16;
        r2 = r17;
        r5 = r0;
        r6 = r19;
        r1.<init>(r3, r4, r5, r6);
        r1 = r18.getPhotos();	 Catch:{ FileNotFoundException -> 0x00b2 }
    ...
    L_0x003b:
        ...
        r3 = r18;
        r13 = r7.getSharePhotoCommonParameters(r2, r3);	 Catch:{ JSONException -> 0x0084 }
        r11 = r2.getBitmap();	 Catch:{ FileNotFoundException -> 0x00b2 }
        r4 = r2.getImageUrl();	 Catch:{ FileNotFoundException -> 0x00b2 }
        r2 = r2.getCaption();	 Catch:{ FileNotFoundException -> 0x00b2 }
        if (r2 != 0) goto L_0x0059;
    L_0x0055:
        r2 = r17.getMessage();	 Catch:{ FileNotFoundException -> 0x00b2 }
    L_0x0059:
        r12 = r2;
        if (r11 == 0) goto L_0x006e;
    L_0x005c:
        r2 = "photos";
        r10 = r7.getGraphPath(r2);	 Catch:{ FileNotFoundException -> 0x00b2 }
        r9 = r15;
        r2 = r14;
        r14 = r16;
        r4 = com.facebook.GraphRequest.newUploadPhotoRequest(r9, r10, r11, r12, r13, r14);	 Catch:{ FileNotFoundException -> 0x00b2 }
    ...
    L_0x0071:
        r5 = "photos";
        r10 = r7.getGraphPath(r5);	 Catch:{ FileNotFoundException -> 0x00b2 }
        r9 = r15;
        r11 = r4;
        r14 = r16;
        r4 = com.facebook.GraphRequest.newUploadPhotoRequest(r9, r10, r11, r12, r13, r14);	 Catch:{ FileNotFoundException -> 0x00b2 }
    ...
    L_0x0084:
        r0 = move-exception;
        r1 = r0;
        com.facebook.share.internal.ShareInternalUtility.invokeCallbackWithException(r8, r1);	 Catch:{ FileNotFoundException -> 0x00b2 }
        return;
    L_0x008a:
        r2 = r14;
        r1 = r0.value;	 Catch:{ FileNotFoundException -> 0x00b2 }
        ...
        r0.value = r1;	 Catch:{ FileNotFoundException -> 0x00b2 }
        r0 = r2.iterator();	 Catch:{ FileNotFoundException -> 0x00b2 }
    L_0x00a2:
        r1 = r0.hasNext();	 Catch:{ FileNotFoundException -> 0x00b2 }
        if (r1 == 0) goto L_0x00b6;
    L_0x00a8:
        r1 = r0.next();	 Catch:{ FileNotFoundException -> 0x00b2 }
        r1 = (com.facebook.GraphRequest) r1;	 Catch:{ FileNotFoundException -> 0x00b2 }
        r1.executeAsync();	 Catch:{ FileNotFoundException -> 0x00b2 }
        goto L_0x00a2;
    L_0x00b2:
        r0 = move-exception;
        com.facebook.share.internal.ShareInternalUtility.invokeCallbackWithException(r8, r0);
    L_0x00b6:
        return;
        */
    ...
    private void shareLinkContent(ShareLinkContent shareLinkContent, final FacebookCallback<Result> facebookCallback) {
        ...
        new GraphRequest(AccessToken.getCurrentAccessToken(), getGraphPath("feed"), bundle, HttpMethod.POST, c39004).executeAsync();
    }
    ...
    private <T> void stageCollectionValues(CollectionMapper.Collection<T> collection, OnMapperCompleteListener onMapperCompleteListener) {
        CollectionMapper.iterate(collection, new C39027(), onMapperCompleteListener);
    }
    ...
    private void stageOpenGraphObject(final ShareOpenGraphObject shareOpenGraphObject, final OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        CollectionMapper.Collection c39049 = new CollectionMapper.Collection<String>() {
            public Iterator<String> keyIterator() {
        ...
        stageCollectionValues(c39049, new OnMapperCompleteListener() {
            public void onComplete() {
