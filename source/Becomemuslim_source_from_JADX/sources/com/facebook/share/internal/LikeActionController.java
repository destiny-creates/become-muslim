...
*/
    ...
    static class C39103 implements Callback {
        C39103() {
        }
    ...
    static class C39115 extends AccessTokenTracker {
        C39115() {
        }
    ...
    class C39179 implements RequestCompletionCallback {
        C39179() {
        }
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        class C39181 implements GraphRequest.Callback {
            C39181() {
            }
        ...
        protected void setRequest(GraphRequest graphRequest) {
            ...
            graphRequest.setCallback(new C39181());
        }
    ...
    private class GetEngagementRequestWrapper extends AbstractRequestWrapper {
        ...
        protected void processSuccess(GraphResponse graphResponse) {
            graphResponse = Utility.tryGetJSONObjectFromResponse(graphResponse.getJSONObject(), PlaceFields.ENGAGEMENT);
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            ...
            CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C39103());
            isInitialized = true;
        }
    }
    ...
    private static void broadcastAction(LikeActionController likeActionController, String str, Bundle bundle) {
        ...
        C0373d.m1138a(FacebookSdk.getApplicationContext()).m1143a(intent);
    }
                ...
                if (bundle != null) {
                    if (bundle.containsKey(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY)) {
                        ...
                        if (bundle.containsKey(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY)) {
                            ...
                            bundle = LikeActionController.this.unlikeToken;
                        }
                        ...
                        LikeActionController.this.updateState(z, string, str, string2, str2, bundle2);
                    }
                }
            }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.isCurrentAccessTokenActive()) {
            fetchVerifiedObjectId(new C39179());
        } else {
                    ...
                    if (bundle != null) {
                        if (bundle.containsKey(ShareConstants.EXTRA_OBJECT_IS_LIKED)) {
                            ...
                            if (bundle.containsKey(ShareConstants.EXTRA_UNLIKE_TOKEN)) {
                                bundle = bundle.getString(ShareConstants.EXTRA_UNLIKE_TOKEN);
                            } else {
                                bundle = LikeActionController.this.unlikeToken;
                            }
                            LikeActionController.this.updateState(z, str, str2, str3, str4, bundle);
                        }
                    }
                }
            });
            ...
            graphRequestBatch.addCallback(new GraphRequestBatch.Callback() {
                public void onBatchCompleted(GraphRequestBatch graphRequestBatch) {
                    ...
                    if (Utility.isNullOrEmpty(LikeActionController.this.verifiedObjectId) != null) {
                        ...
                        graphRequestBatch = LikeActionController.this;
                        ...
                        graphRequestBatch.logAppEventForError(str, error);
                    }
