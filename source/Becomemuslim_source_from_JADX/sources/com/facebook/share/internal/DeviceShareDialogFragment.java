...
public class DeviceShareDialogFragment extends C4457h {
    ...
    class C20041 implements OnClickListener {
        C20041() {
        }
    ...
    class C20053 implements Runnable {
        C20053() {
        }
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C20061();
        private long expiresIn;
        private String userCode;

        /* renamed from: com.facebook.share.internal.DeviceShareDialogFragment$RequestState$1 */
        static class C20061 implements Creator<RequestState> {
            C20061() {
            }
    ...
    class C39082 implements Callback {
        C39082() {
        }
...
*/
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        bundle = getActivity().getLayoutInflater().inflate(C1729R.layout.com_facebook_device_auth_dialog_fragment, null);
        this.progressBar = (ProgressBar) bundle.findViewById(C1729R.id.progress_bar);
        this.confirmationCode = (TextView) bundle.findViewById(C1729R.id.confirmation_code);
        ((Button) bundle.findViewById(C1729R.id.cancel_button)).setOnClickListener(new C20041());
        ((TextView) bundle.findViewById(C1729R.id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C1729R.string.com_facebook_device_auth_instructions)));
    ...
    private void detach() {
        if (isAdded()) {
            getFragmentManager().mo201a().mo184a((C3178i) this).mo189c();
        }
    }
    ...
    private void startShare() {
        ...
        new GraphRequest(null, DEVICE_SHARE_ENDPOINT, graphParametersForShareContent, HttpMethod.POST, new C39082()).executeAsync();
    }
    ...
    private void setCurrentRequestState(RequestState requestState) {
        ...
        this.codeExpiredFuture = getBackgroundExecutor().schedule(new C20053(), requestState.getExpiresIn(), TimeUnit.SECONDS);
    }
}
