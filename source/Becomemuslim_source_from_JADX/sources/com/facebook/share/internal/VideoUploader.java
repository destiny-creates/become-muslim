...
public class VideoUploader {
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int i) {
            ...
            VideoUploader.getHandler().postDelayed(new C20171(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
    ...
    static class C39311 extends AccessTokenTracker {
        C39311() {
        }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C20141();

        /* renamed from: com.facebook.share.internal.VideoUploader$FinishUploadWorkItem$1 */
        static class C20141 extends HashSet<Integer> {
            C20141() {
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C20151();

        /* renamed from: com.facebook.share.internal.VideoUploader$StartUploadWorkItem$1 */
        static class C20151 extends HashSet<Integer> {
            C20151() {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C20161();
        ...
        static class C20161 extends HashSet<Integer> {
            C20161() {
    ...
    private static byte[] getChunk(UploadContext uploadContext, String str, String str2) {
        if (Utility.areObjectsEqual(str, uploadContext.chunkStart)) {
            ...
            byte[] bArr = new byte[Math.min(Utility.DEFAULT_STREAM_BUFFER_SIZE, str)];
            do {
