...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static void show(C3178i c3178i, GameRequestContent gameRequestContent) {
        show(new FragmentWrapper(c3178i), gameRequestContent);
    }
    ...
    public GameRequestDialog(C3178i c3178i) {
