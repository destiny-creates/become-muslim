...
public class AppInviteDialog extends FacebookDialogBase<AppInviteContent, Result> {
    ...
    @Deprecated
    public static void show(C3178i c3178i, AppInviteContent appInviteContent) {
        show(new FragmentWrapper(c3178i), appInviteContent);
    }
    ...
    @Deprecated
    public AppInviteDialog(C3178i c3178i) {
