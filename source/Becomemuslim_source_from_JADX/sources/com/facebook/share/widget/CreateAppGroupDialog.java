...
public class CreateAppGroupDialog extends FacebookDialogBase<AppGroupCreationContent, Result> {
    ...
    @Deprecated
    public static void show(C3178i c3178i, AppGroupCreationContent appGroupCreationContent) {
        show(new FragmentWrapper(c3178i), appGroupCreationContent);
    }
    ...
    @Deprecated
    public CreateAppGroupDialog(C3178i c3178i) {
