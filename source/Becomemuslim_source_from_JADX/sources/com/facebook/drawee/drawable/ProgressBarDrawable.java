...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    private int mBackgroundColor = LinearLayoutManager.INVALID_OFFSET;
    ...
    public boolean getPadding(Rect rect) {
        ...
        return this.mPadding != null ? true : null;
    }
    ...
    private void drawHorizontalBar(Canvas canvas, int i, int i2) {
        ...
        int i3 = (bounds.bottom - this.mPadding) - this.mBarWidth;
        this.mRect.set((float) i, (float) i3, (float) (i + width), (float) (i3 + this.mBarWidth));
        drawBar(canvas, i2);
    }
