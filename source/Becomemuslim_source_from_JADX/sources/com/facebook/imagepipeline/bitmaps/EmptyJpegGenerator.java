    ...
    public CloseableReference<PooledByteBuffer> generate(short s, short s2) {
        ...
        try {
            ...
            try {
                ...
                newOutputStream.write((byte) (s2 & JfifUtil.MARKER_FIRST_BYTE));
                newOutputStream.write((byte) (s >> 8));
                newOutputStream.write((byte) (s & JfifUtil.MARKER_FIRST_BYTE));
                newOutputStream.write(EMPTY_JPEG_SUFFIX);
                s = CloseableReference.of(newOutputStream.toByteBuffer());
