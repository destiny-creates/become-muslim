...
public class ThumbnailBranchProducer implements Producer<EncodedImage> {
    ...
    private class ThumbnailConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        protected void onNewResultImpl(EncodedImage encodedImage, int i) {
            ...
            } else if (BaseConsumer.isLast(i) != 0) {
                EncodedImage.closeSafely(encodedImage);
                if (ThumbnailBranchProducer.this.produceResultsFromThumbnailProducer(this.mProducerIndex + 1, getConsumer(), this.mProducerContext) == null) {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        } else if (produceResultsFromThumbnailProducer(0, consumer, producerContext) == null) {
            consumer.onNewResult(null, 1);
        }
    }
