...
public class ImagePipelineConfig {
    ...
    class C37501 implements Supplier<Boolean> {
        C37501() {
        }
    ...
    private ImagePipelineConfig(Builder builder) {
        ...
        if (builder.mIsPrefetchEnabledSupplier == null) {
            defaultBitmapMemoryCacheParamsSupplier = new C37501();
        } else {
        ...
        builder = this.mImagePipelineExperiments.getWebpBitmapFactory();
        if (builder != null) {
            setWebpBitmapFactory(builder, this.mImagePipelineExperiments, new HoneycombBitmapCreator(getPoolFactory()));
        } else if (this.mImagePipelineExperiments.isWebpSupportEnabled() != null && WebpSupportStatus.sIsWebpSupportRequired != null) {
            builder = WebpSupportStatus.loadWebpBitmapFactoryIfExists();
            if (builder != null) {
                setWebpBitmapFactory(builder, this.mImagePipelineExperiments, new HoneycombBitmapCreator(getPoolFactory()));
            }
        }
    ...
    private static void setWebpBitmapFactory(WebpBitmapFactory webpBitmapFactory, ImagePipelineExperiments imagePipelineExperiments, BitmapCreator bitmapCreator) {
        ...
        imagePipelineExperiments = imagePipelineExperiments.getWebpErrorLogger();
        if (imagePipelineExperiments != null) {
            webpBitmapFactory.setWebpErrorLogger(imagePipelineExperiments);
        }
