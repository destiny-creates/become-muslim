...
public class ProducerFactory {
    ...
    public ResizeAndRotateProducer newResizeAndRotateProducer(Producer<EncodedImage> producer, boolean z, boolean z2) {
        Executor forBackgroundTasks = this.mExecutorSupplier.forBackgroundTasks();
        PooledByteBufferFactory pooledByteBufferFactory = this.mPooledByteBufferFactory;
        boolean z3 = z && !this.mDownsampleEnabled;
        return new ResizeAndRotateProducer(forBackgroundTasks, pooledByteBufferFactory, z3, producer, z2);
    }
